function AdminMenu()
	...
	local Menu = DermaMenu() -- Main Menu
	...
	local PlayersMenu = Menu:AddSubMenu("Players") -- Players Menu
	Menu:AddSpacer()
	local ChangeMapMenu = Menu:AddSubMenu("Change Map") -- Players Menu
	--PlayersMenu:SetImage("gui/silkicons/map")
		...
		for _,ply in pairs(player.GetAll()) do
			...
			IndPlayer:AddOption("Ban",function() 
											print("Ban Func") 
										end)
