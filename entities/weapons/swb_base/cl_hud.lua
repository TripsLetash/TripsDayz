...
surface.CreateFont("SWB_KillIcons2", {font = "HalfLife2", size = ScreenScale(30), weight = 500, blursize = 0, antialias = true, shadow = false})
surface.CreateFont("SWB_SelectIcons2", {font = "HalfLife2", size = ScreenScale(60), weight = 500, blursize = 0, antialias = true, shadow = false})
...
function SWEP:DrawHUD()
	...
	elseif self.FireModeDisplayPos == "middle" then
		draw.ShadowText(self.FireModeDisplay, "SWB_HUD16", x * 0.5, y - 100, White, Black, 1, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	...
	elseif self.FireModeDisplayPos == "left" then
		sc1, sc2 = ScreenScale(35), ScreenScale(44)
		draw.ShadowText(self.FireModeDisplay, "SWB_HUD16", sc1, y - sc2 - 20, White, Black, 1, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		
		if self.BulletDisplay and self.BulletDisplay > 0 then
			surface.SetDrawColor(0, 0, 0, 255)
			surface.SetTexture(Bullet)
			
			surface.SetFont("SWB_HUD16")
