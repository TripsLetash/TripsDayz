...
concommand.Add( "slotm_setbet", function( ply, cmd, args )
	if !Casino.SlotsSettingBet then
		...
		Derma_StringRequest( "Slot Machine", "Set the amount of money you would like to bet. (5 - 1000)", Casino.SlotsLocalBet, 
						function( strTextOut )
							local amount = tonumber( strTextOut ) or Casino.SlotsLocalBet
							Casino.SlotsLocalBet = math.Clamp( math.Round(amount), 5, Casino.SlotsMaxBet )
							Casino.SlotsSettingBet = false
						end,
						function( strTextOut )
							Casino.SlotsSettingBet = false
